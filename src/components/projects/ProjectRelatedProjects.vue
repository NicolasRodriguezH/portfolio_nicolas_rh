...
<template>
	...
	>
		<p
			class="font-general-regular text-primary-dark dark:text-primary-light text-3xl font-bold mb-10 sm:mb-14 text-center"
		>
			{{ relatedProject.relatedProjectsHeading }}
		</p>

		<div class="flex grid-cols-1 sm:grid-cols-4 gap-10 flex-col items-center">
